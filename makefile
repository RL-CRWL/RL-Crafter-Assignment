...
eval_rppo_src=Reinforcement-Learning-Project-2026-Crafter/src/evaluation/Evaluate-Recurrent.py
...
Results: $(eval_src) $(eval_rppo_src) 
	...
	python $(eval_rppo_src) --model $(ppo_improv_2) --n_episodes $(episodes) --save_dir $(ppo_2_save)

Results_PPO_2: $(eval_rppo_src) 
	python $(eval_rppo_src) --model $(ppo_improv_2) --n_episodes $(episodes) --save_dir $(ppo_2_save)