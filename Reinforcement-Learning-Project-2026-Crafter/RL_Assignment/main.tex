...
\begin{table}[H]
	...
	\begin{tabular}{lcc}
		\toprule
		\textbf{Metric} & \textbf{Baseline} & \textbf{Improvement 2} \\
		\midrule
		Mean reward & $3.56 \pm 1.70$ & $3.26 \pm 1.24$ \\
		$\Delta$ from baseline & --- & \textcolor{red}{-8.4\%} \\
		Mean survival time & (not reported) & (not reported) \\
		Achievements unlocked & 10/22 & 7/22 \\
		Geometric mean & 24.91\% & 44.16\% \\
		$\Delta$ from baseline & --- & \textcolor{blue}{+77.3\%} \\
		\bottomrule
	\end{tabular}
	\caption{Performance comparison: Baseline vs Improvement 2}
\end{table}

\subsubsection*{Improvement 1 vs Improvement 2 Comparison}

To better understand the differences between the two improvements, we compare their mean rewards, achievement performance, and overall progress:

\begin{table}[H]
	\centering
	\begin{tabular}{lcc}
		\toprule
		\textbf{Metric} & \textbf{Improvement 1} & \textbf{Improvement 2} \\
		\midrule
		Mean reward & $4.38 \pm 1.33$ & $3.26 \pm 1.24$ \\
		Achievements unlocked & 10/22 & 7/22 \\
		Geometric mean & 37.18\% & 44.16\% \\
		\bottomrule
	\end{tabular}
	\caption{Performance comparison: Improvement 1 vs Improvement 2}
\end{table}
